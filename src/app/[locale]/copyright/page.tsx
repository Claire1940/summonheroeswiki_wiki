...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Summon Heroes Wiki',
    description: 'Copyright and intellectual property information for Summon Heroes Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Summon Heroes Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Summon Heroes Wiki',
      description: 'Copyright and intellectual property information for Summon Heroes Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Summon Heroes Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Summon Heroes Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Summon Heroes Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Summon Heroes Developers</strong> - Creators of the Summon Heroes game</li>
            </ul>
            <p>
            ...
            <p>
              ...
              affiliation with Summon Heroes Wiki.
            </p>
            ...
            <p>
              ...
              Summon Heroes Wiki<br />
              Email: <a href="mailto:dmca@summonheroeswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@summonheroeswiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Summon Heroes Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Summon Heroes Wiki (summonheroeswiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@summonheroeswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@summonheroeswiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@summonheroeswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@summonheroeswiki.wiki</a>
            </p>
            <p>
