...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Summon Heroes Wiki',
    description: 'Summon Heroes Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Roblox game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Summon Heroes Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Summon Heroes Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Summon Heroes Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with RedManta LLC (Roblox) or the developers of Summon Heroes. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@summonheroeswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@summonheroeswiki.wiki</a>
            </p>
            <p>
