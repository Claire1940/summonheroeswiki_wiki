...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Summon Heroes Wiki",
    description: "Read the Terms of Service for Summon Heroes Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    keywords: [
      'terms of service',
      "Summon Heroes Wiki terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - Summon Heroes Wiki",
      description: "Terms and conditions for using Summon Heroes Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Summon Heroes Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Summon Heroes Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Summon Heroes Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Summon Heroes Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
            ...
            <p>
              <strong>Important:</strong> Summon Heroes Wiki is NOT affiliated with, endorsed by, or associated with
              RedManta LLC (Roblox) or the official developers of Summon Heroes. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Summon Heroes Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of RedManta LLC (Roblox) and/or the developers of Summon Heroes. We use such
            ...
            <p>
              ...
              you and Summon Heroes Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@summonheroeswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@summonheroeswiki.wiki</a>
            </p>
            <p>
